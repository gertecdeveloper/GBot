...
begin
  TRegTypes.RegisterType('SatInterfaces.JUsbAccessory', TypeInfo(SatInterfaces.JUsbAccessory));
  TRegTypes.RegisterType('SatInterfaces.JUsbConfiguration', TypeInfo(SatInterfaces.JUsbConfiguration));
  TRegTypes.RegisterType('SatInterfaces.JUsbDevice', TypeInfo(SatInterfaces.JUsbDevice));
  TRegTypes.RegisterType('SatInterfaces.JUsbDeviceConnection', TypeInfo(SatInterfaces.JUsbDeviceConnection));
  TRegTypes.RegisterType('SatInterfaces.JUsbEndpoint', TypeInfo(SatInterfaces.JUsbEndpoint));
  TRegTypes.RegisterType('SatInterfaces.JUsbInterface', TypeInfo(SatInterfaces.JUsbInterface));
  TRegTypes.RegisterType('SatInterfaces.JUsbManager', TypeInfo(SatInterfaces.JUsbManager));
  TRegTypes.RegisterType('SatInterfaces.JUsbRequest', TypeInfo(SatInterfaces.JUsbRequest));
  TRegTypes.RegisterType('SatInterfaces.Jsatger_BuildConfig', TypeInfo(SatInterfaces.Jsatger_BuildConfig));
  TRegTypes.RegisterType('SatInterfaces.JSatGerConnectionManager', TypeInfo(SatInterfaces.JSatGerConnectionManager));
  TRegTypes.RegisterType('SatInterfaces.JSatGerConnectionManager_1', TypeInfo(SatInterfaces.JSatGerConnectionManager_1));
  TRegTypes.RegisterType('SatInterfaces.JSatGerConnectionManager_2', TypeInfo(SatInterfaces.JSatGerConnectionManager_2));
  TRegTypes.RegisterType('SatInterfaces.JSatGerConnectionManager_ConnectionFailedException', TypeInfo(SatInterfaces.JSatGerConnectionManager_ConnectionFailedException));
  TRegTypes.RegisterType('SatInterfaces.JSatGerConnectionManager_Listener', TypeInfo(SatInterfaces.JSatGerConnectionManager_Listener));
  TRegTypes.RegisterType('SatInterfaces.JSatGerLib', TypeInfo(SatInterfaces.JSatGerLib));
  TRegTypes.RegisterType('SatInterfaces.JSatGerLib_OnDataReceived', TypeInfo(SatInterfaces.JSatGerLib_OnDataReceived));
  TRegTypes.RegisterType('SatInterfaces.JSatGerProtocolParser', TypeInfo(SatInterfaces.JSatGerProtocolParser));
  TRegTypes.RegisterType('SatInterfaces.JSerialInputOutputManager_Listener', TypeInfo(SatInterfaces.JSerialInputOutputManager_Listener));
  TRegTypes.RegisterType('SatInterfaces.JSatGerProtocolParser_1', TypeInfo(SatInterfaces.JSatGerProtocolParser_1));
  TRegTypes.RegisterType('SatInterfaces.J1_1', TypeInfo(SatInterfaces.J1_1));
  TRegTypes.RegisterType('SatInterfaces.JSatGerProtocolParser_2', TypeInfo(SatInterfaces.JSatGerProtocolParser_2));
  TRegTypes.RegisterType('SatInterfaces.JUsbSerialDriver', TypeInfo(SatInterfaces.JUsbSerialDriver));
  TRegTypes.RegisterType('SatInterfaces.JCdcAcmSerialDriver', TypeInfo(SatInterfaces.JCdcAcmSerialDriver));
  TRegTypes.RegisterType('SatInterfaces.JUsbSerialPort', TypeInfo(SatInterfaces.JUsbSerialPort));
  TRegTypes.RegisterType('SatInterfaces.JCommonUsbSerialPort', TypeInfo(SatInterfaces.JCommonUsbSerialPort));
  TRegTypes.RegisterType('SatInterfaces.JCdcAcmSerialDriver_CdcAcmSerialPort', TypeInfo(SatInterfaces.JCdcAcmSerialDriver_CdcAcmSerialPort));
  TRegTypes.RegisterType('SatInterfaces.JHexDump', TypeInfo(SatInterfaces.JHexDump));
  TRegTypes.RegisterType('SatInterfaces.JProbeTable', TypeInfo(SatInterfaces.JProbeTable));
  TRegTypes.RegisterType('SatInterfaces.JSerialInputOutputManager', TypeInfo(SatInterfaces.JSerialInputOutputManager));
  TRegTypes.RegisterType('SatInterfaces.JSerialInputOutputManager_State', TypeInfo(SatInterfaces.JSerialInputOutputManager_State));
  TRegTypes.RegisterType('SatInterfaces.JUsbId', TypeInfo(SatInterfaces.JUsbId));
  TRegTypes.RegisterType('SatInterfaces.JUsbSerialProber', TypeInfo(SatInterfaces.JUsbSerialProber));
  TRegTypes.RegisterType('SatInterfaces.JUsbSerialRuntimeException', TypeInfo(SatInterfaces.JUsbSerialRuntimeException));
end;
