  ...
  void alterarCodigoSat() async {
    ...
    if (commonGertec.isCodigoValido(codigoAtivacao.text) && commonGertec.isCodigoValido(codigoAtivacaoNovo.text)) {
      if (codigoAtivacaoNovo.text == confirmacaoCodigo.text) {
        ...
        WidgetsGertec.dialogo("O Código de Ativação Novo e a Confirmação do Código de Ativação não correspondem!", context: context);
      }
    } else {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 30),
              dropDownList(),
              WidgetsGertec.formField(codigoAtivacao, "Atual: ", iWidht: 400),
              WidgetsGertec.formField(codigoAtivacaoNovo, "Novo: ", iWidht: 400),
              WidgetsGertec.formField(confirmacaoCodigo, "Confirmar: ", iWidht: 400),
              WidgetsGertec.buttonStandard("ALTERAR", callback: () => alterarCodigoSat()),
            ],
          ),
        ),
      ),
