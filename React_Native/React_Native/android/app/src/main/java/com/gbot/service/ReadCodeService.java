...
public class ReadCodeService extends JobIntentService {
    ...
    public static void enqueueWork(Context context, ServiceResultReceiver workerResultReceiver) {
        ...
        // System.out.println("workerResultReceiver: " + workerResultReceiver);
        // System.out.println("ReadCodeService.class: " + ReadCodeService.class);

        Intent intent = new Intent(context, ReadCodeService.class);
        intent.putExtra(RECEIVER, workerResultReceiver);
        intent.setAction(ACTION_READ_CODE);
        // if(context != null) System.out.println("CONTEXT Não é NULO!");

        countDownLatch = new CountDownLatch(1);
        START_SERVICES = true;

        // System.out.println("ACTION_READ_CODE " + ACTION_READ_CODE);
        // System.out.println("countDownLatch " + countDownLatch);
        // System.out.println("START_SERVICES " + START_SERVICES);
        // System.out.println("READCODE_JOB_ID " + READCODE_JOB_ID);
    ...
    private String scanner() throws RemoteException {
        ...
        if(ret == 0){
            ...
            mediaPlayer.start();
            System.out.println("Leitura efetuada " + codeRead);
            return codeRead;
        }
