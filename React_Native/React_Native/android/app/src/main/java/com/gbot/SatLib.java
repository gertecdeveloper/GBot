...
public class SatLib {
    ...
    public String enviarConfRede(int random, ReadableArray dadosXml, String codigoAtivacao) throws IOException {
        ...
        String caminhoXML = "data/data/"+ com.gbot.BuildConfig.APPLICATION_ID +"/configRede.xml";
        ...
        bw.newLine();
        bw.write(dadosXml.getString(0));
        bw.newLine();

        if (!dadosXml.getString(1).equals("")) {
            bw.write(dadosXml.getString(1));
            bw.newLine();
        }
        if (!dadosXml.getString(2).equals("")) {
            bw.write(dadosXml.getString(2));
            bw.newLine();
        }
        if (!dadosXml.getString(3).equals("")) {
            bw.write(dadosXml.getString(3));
            bw.newLine();
        }
        if (!dadosXml.getString(4).equals("")) {
            bw.write(dadosXml.getString(4));
            bw.newLine();
        }
        if (!dadosXml.getString(5).equals("")) {
            bw.write(dadosXml.getString(5));
            bw.newLine();
        }

        bw.write(dadosXml.getString(6));
        bw.newLine();

        if (!dadosXml.getString(7).equals("")) {
            bw.write(dadosXml.getString(7));
            bw.newLine();
        }
        if (!dadosXml.getString(8).equals("")) {
            bw.write(dadosXml.getString(8));
            bw.newLine();
        }
        if (!dadosXml.getString(9).equals("")) {
            bw.write(dadosXml.getString(9));
            bw.newLine();
        }
        if (!dadosXml.getString(10).equals("")) {
            bw.write(dadosXml.getString(10));
            bw.newLine();
        }
