...
public class Impressora extends AppCompatActivity implements View.OnClickListener {
    ...
    void ExecutaImpressaoGlass(int ViewId) {
        if (ViewId == R.id.btnStatusImpressora) {
            ShowStatusImpressora();
        } else if (ViewId == R.id.btnImprimir) {
            ImprimirTexto();
        } else if (ViewId == R.id.btnImagem) {
            ImprimeImagem();
        } else if (ViewId == R.id.btnBarCode) {
            ImprimeCodigoBarras();
        } else if (ViewId == R.id.btnDiversasFuncoes) {
