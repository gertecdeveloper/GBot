...
namespace GBotXamarinForms.Droid.SAT.PagesSat
{
    ...
    public class Ferramentas : Activity, ISatFerramentas
    {
        ...
        public void RespostaSat(string operacao, string codAtivacao, int numSessao)
        {
            ...
            Xamarin.Forms.MessagingCenter.Send(Xamarin.Forms.Application.Current, "SAT_Response_Notification", retornoFormatado);
        }
